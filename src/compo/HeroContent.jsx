...
function HeroContent({summary}) {
  return (
    <div className='w-full my-10 flex flex-col gap-2 justify-start items-center '>
        <h1 className='text-3xl md:text-7xl font-extrabold font-Inter Inter-font text-center'>Summarize Articles with </h1>
        <h1 className='text-3xl text-gradient md:text-7xl font-extrabold font-Inter Inter-font text-center '>OpenAI GPT-4</h1>
